...
DROP POLICY IF EXISTS "Coordinadores and admins can insert students" ON public.students;
DROP POLICY IF EXISTS "Coordinadores and admins can update students" ON public.students;
DROP POLICY IF EXISTS "Coordinadores and admins can delete students" ON public.students;
...
DROP POLICY IF EXISTS "Coordinadores and admins can insert subjects" ON public.subjects;
DROP POLICY IF EXISTS "Coordinadores and admins can update subjects" ON public.subjects;
DROP POLICY IF EXISTS "Coordinadores and admins can delete subjects" ON public.subjects;
...
DROP POLICY IF EXISTS "Coordinadores and admins can insert roles" ON public.user_roles;
DROP POLICY IF EXISTS "Coordinadores and admins can update roles" ON public.user_roles;
DROP POLICY IF EXISTS "Coordinadores and admins can delete roles" ON public.user_roles;
DROP POLICY IF EXISTS "Coordinadores and admins can view all roles" ON public.user_roles;
...
-- Attendances
DROP POLICY IF EXISTS "Users can insert attendances" ON public.attendances;
...
DROP POLICY IF EXISTS "Coordinadores and admins can delete attendances" ON public.attendances;
...
-- Predictions
DROP POLICY IF EXISTS "Coordinadores and admins can insert predictions" ON public.dropout_predictions;
DROP POLICY IF EXISTS "Coordinadores and admins can update predictions" ON public.dropout_predictions;
DROP POLICY IF EXISTS "Coordinadores and admins can delete predictions" ON public.dropout_predictions;
...
-- Recommendations
DROP POLICY IF EXISTS "Coordinadores and admins can insert recommendations" ON public.recommendations;
DROP POLICY IF EXISTS "Coordinadores and admins can delete recommendations" ON public.recommendations;
